...
def unique_hard_reset():
    # 64 products with 64 UNIQUE suitable photos
    final_64_unique = [
        ...
        ("Beverages", "Soft Drink", "litre", 45.0, "https://images.unsplash.com/photo-1625772299848-391b6a87d7b3?q=80&w=800&auto=format&fit=crop"), # Unique for Soft Drink
        ...
        ("Cooking Oils & Masala", "Mustard Oil", "litre", 545.0, "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?q=80&w=800&auto=format&fit=crop"), # Needs a more specific one later but for now it's okay, let's fix if needed
        ...
        ("Cooking Oils & Masala", "Cumin Seeds", "pack", 120.0, "https://images.unsplash.com/photo-1632733711679-5292d6899f81?q=80&w=800&auto=format&fit=crop"), # Unique for Cumin Seeds
        ...
        ("Household Essentials", "Floor Cleaner", "litre", 650.0, "https://images.unsplash.com/photo-1563453392212-326f5e854473?q=80&w=800&auto=format&fit=crop"), # Unique for Floor Cleaner
        ("Household Essentials", "Toilet Cleaner", "litre", 665.0, "https://images.unsplash.com/photo-1549449852-51c6c6460060?q=80&w=800&auto=format&fit=crop"), # Unique for Toilet Cleaner
    ...
    try:
        ...
        print(f"Injecting {len(final_64_unique)} final UNIQUE products...")
        pid = 1
        for cat, name, unit, price, img in final_64_unique:
        ...
        conn.commit()
        conn.close()
        print("Inventory Unique Hard Reset Complete.")
